...
- `visit_addrs` (Attributes Set) Connection address information. (see [below for nested schema](#nestedatt--visit_addrs))
...
- `server_nodes` (Attributes List) Detailed list of all Server nodes in the shard. (see [below for nested schema](#nestedatt--instance_shards--server_nodes))
