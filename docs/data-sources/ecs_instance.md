...
page_title: "volcenginecc_ecs_instance Data Source - terraform-provider-volcenginecc"
subcategory: "ECS"
description: |-
  Data Source schema for Volcengine::ECS::Instance
---

# volcenginecc_ecs_instance (Data Source)
...
- `data_volumes` (Attributes List) Instance data disks. Supports up to 15 data disks. When creating, data disks are created together with the system disk via RunInstances. When querying, cloud disk details are completed through the Elastic Block Storage DescribeVolumes API. (see [below for nested schema](#nestedatt--data_volumes))
