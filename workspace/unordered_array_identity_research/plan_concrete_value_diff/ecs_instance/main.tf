...
resource "volcenginecc_vpc_security_group" "plan" {
  ...
  security_group_name = "tf-multiset-concrete-plan-e2e-sg"
  description         = "Temporary security group for concrete Multiset plan validation"
  project_name        = "default"
}

resource "volcenginecc_ecs_instance" "plan" {
  instance_name        = "tf-multiset-concrete-plan-e2e"
  hostname             = "tf-multiset-concrete-plan-e2e"
  description          = "Temporary ECS instance for concrete Multiset plan validation"
  project_name         = "default"
